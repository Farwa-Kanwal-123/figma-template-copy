...
const About = () => {
  return (
    <main className="w-full">
      <div className="w-[1000px] h-[850px] mt-[135px] mb-[108px] mx-[100px] border-[#727070] border-t-[2px] border-b-[2px] font-serif">
        <div className="grid gap-[96px] mb-[146px] pt-[71px] px-[130px]">
          <div>
            <h1 className="text-center text-[24px]">About Us</h1>
          </div>
          <div>
            <p className="text-center">
              ...
              When she has got clean skin and young skin. But I have got problem
              skin. I have got acne, acne scars and acne on body. I want so that
              this site been for you good informant about cosmetics. Here you
              can read only comments different people about cosmetics or
          ...
          <div className="text-center">We love you!</div>
        </div>
      </div>
    </main>
  );
